...
from src.OTLMOW.OTLModel.Datatypes.KlMIVLusUitslijprichting import KlMIVLusUitslijprichting
from src.OTLMOW.OTLModel.Datatypes.KlMIVLusZichtbaarheid import KlMIVLusZichtbaarheid
