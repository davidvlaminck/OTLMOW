...
class OTLObjectHelperTest(unittest.TestCase):
    def test_list_attributes_and_values_by_dotnotatie_simple_attributes(self):
        instance = AllCasesTestClass()
        instance.testKeuzelijst = 'waarde-2'
        instance.testBooleanField = True
        attribute_list = list(instance.list_attributes_and_values_by_dotnotatie())
        expected_list = [('testBooleanField', True),
                         ('testKeuzelijst', 'waarde-2')]
        self.assertListEqual(expected_list, attribute_list)

    def test_list_attributes_and_values_by_dotnotatie_complex_attributes(self):
        instance = AllCasesTestClass()
    ...
    def test_list_attributes_and_values_by_dotnotatie_attributes_with_cardinality(self):
        instance = AllCasesTestClass()
    ...
    def test_list_attributes_and_values_by_dotnotatie_waarde_shortcut(self):
        instance = AllCasesTestClass()
        ...
        instance.testUnionType.unionKwantWrd.waarde = 2.0
        attribute_list = list(instance.list_attributes_and_values_by_dotnotatie(waarde_shortcut=True))
