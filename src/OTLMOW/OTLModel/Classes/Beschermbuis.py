...
from OTLMOW.OTLModel.Classes.Leiding import Leiding
...
class Beschermbuis(OmhullendeInrichting, Leiding):
    ...
    def __init__(self):
        ...
        self._indicatieveDiepte = OTLAttribuut(field=KwantWrdInCentimeter,
...
Bij een discrepantie tussen de waarde van dit attribuut en de waarde in TAW uit de geometrie van het object, geldt altijd de waarde in TAW.',
                                               definition='De opgemeten diepte als een (positief) getal in centimeter tussen het hoogste punt van de buis en het maaiveld zoals dit gekend was op het moment van aanleg van de buis.',
                                               owner=self)
    ...
    def indicatieveDiepte(self):
        """De opgemeten diepte als een (positief) getal in centimeter tussen het hoogste punt van de buis en het maaiveld zoals dit gekend was op het moment van aanleg van de buis."""
        return self._indicatieveDiepte.waarde
    ...
    def isFlexibel(self):
        ...
        return self._isFlexibel.waarde
    ...
    def voorzorgsmaatregel(self):
        ...
        return self._voorzorgsmaatregel.waarde
