...
from src.OTLMOW.OTLModel.Datatypes.KlDynBordOpMaatMerk import KlDynBordOpMaatMerk
from src.OTLMOW.OTLModel.Datatypes.KlDynBordOpMaatModelnaam import KlDynBordOpMaatModelnaam
