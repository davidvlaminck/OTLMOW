...
class IntegerFieldTests(TestCase):
    ...
    def test_convert_to_correct_type(self):
        ...
        self.assertEquals(1, IntegerField.convert_to_correct_type(True))
        self.assertEquals(0, IntegerField.convert_to_correct_type(False))
        self.assertEquals(1, IntegerField.convert_to_correct_type('1'))
        self.assertEquals(1, IntegerField.convert_to_correct_type(1.0))
