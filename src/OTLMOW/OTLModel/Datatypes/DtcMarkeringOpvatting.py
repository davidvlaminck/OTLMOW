...
from src.OTLMOW.OTLModel.Datatypes.KlMarkeringWaarborgperiode import KlMarkeringWaarborgperiode
from src.OTLMOW.OTLModel.Datatypes.KlSignalisatieMarkeringOpvatting import KlSignalisatieMarkeringOpvatting
