...
class KlLETrottoirbandType(Keuzelijst):
    ...
    def __init__(self):
        ...
        self.add_option("beton-type-I-A", "beton type I A", "type I A", "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLETrottoirbandType/beton-type-I-A")
        self.add_option("beton-type-I-B", "beton type I B", "type I B", "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLETrottoirbandType/beton-type-I-B")
        self.add_option("beton-type-I-C1", "beton type I C1", "type I C1", "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLETrottoirbandType/beton-type-I-C1")
        self.add_option("beton-type-I-C2", "beton type I C2", "type I C2", "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLETrottoirbandType/beton-type-I-C2")
        self.add_option("beton-type-I-D1", "beton type I D1", "type I D1", "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLETrottoirbandType/beton-type-I-D1")
        self.add_option("beton-type-I-D2", "beton type I D2", "type I D2", "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLETrottoirbandType/beton-type-I-D2")
        self.add_option("beton-type-I-D3", "beton type I D3", "type I D3", "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLETrottoirbandType/beton-type-I-D3")
        self.add_option("beton-type-I-D4", "beton type I D4", "type I D4", "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLETrottoirbandType/beton-type-I-D4")
        ...
        self.add_option("natuursteen-type-C-I-1", "natuursteen type C I 1", "natuursteen type C I 1", "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlLETrottoirbandType/natuursteen-type-C-I-1")
