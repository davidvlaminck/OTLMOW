...
class KlassiekeFundering(BetonnenConstructieElement, Fundering):
    ...
    def __init__(self):
        ...
        self.funderingshoogte.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#KlassiekeFundering.funderingshoogte"
        ...
        self.grondvlakAfmeting.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#KlassiekeFundering.grondvlakAfmeting"
