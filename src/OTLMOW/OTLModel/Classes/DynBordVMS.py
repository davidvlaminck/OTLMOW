...
from src.OTLMOW.OTLModel.Datatypes.KlDynBordVMSMerk import KlDynBordVMSMerk
from src.OTLMOW.OTLModel.Datatypes.KlDynBordVMSModelnaam import KlDynBordVMSModelnaam
