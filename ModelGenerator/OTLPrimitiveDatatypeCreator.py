...
class OTLPrimitiveDatatypeCreator(AbstractDatatypeCreator):
    ...
    def CreateBlockToWriteFromPrimitiveTypesKwantWrd(self, osloDatatypePrimitive: OSLODatatypePrimitive):
        ...
        datablock.append(f'                                              label={wrap_in_quotes(eenheidType.label_nl)},')
        datablock.append(f'                                              objectUri={wrap_in_quotes(eenheidType.objectUri)},')
        datablock.append(f'                                              definition={wrap_in_quotes(eenheidType.definition_nl)},')
        ...
        datablock.append(f'                                              usagenote={wrap_in_quotes(eenheidType.usagenote_nl)})')
        ...
        datablock.append(f'    naam = {wrap_in_quotes(waardeType.name)}')
        datablock.append(f'    label = {wrap_in_quotes(waardeType.label_nl)}')
        datablock.append(f'    objectUri = {wrap_in_quotes(waardeType.objectUri)}')
        datablock.append(f'    definition = {wrap_in_quotes(waardeType.definition_nl)}')
        if waardeType.deprecated_version != '':
            datablock.append(f'    constraints={wrap_in_quotes(waardeType.deprecated_version)}')
