...
from src.OTLMOW.OTLModel.Datatypes.KlOverlangseMarkeringCode import KlOverlangseMarkeringCode
from src.OTLMOW.OTLModel.Datatypes.KlOverlangsemarkeringType import KlOverlangsemarkeringType
