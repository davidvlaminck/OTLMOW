...
class TestInstance:
    boolean = BooleanField(naam="booleanField", label="booleanField", uri="booleanField", definition="definitie booleanField"
                           , constraints="", usagenote="", deprecated_version="")
    """doc for boolean"""

    string = StringField(naam="StringField", label="StringField", uri="StringField", definition="definitie StringField"
                           , constraints="", usagenote="", deprecated_version="")
    """doc for string"""

    int = IntField(naam="IntField", label="IntField", uri="IntField", definition="definitie IntField"
                         , constraints="", usagenote="", deprecated_version="")
    """doc for int"""
...
class PrimitiveTypeTests(unittest.TestCase):
    ...
    def test_stringTests(self):
        ...
        self.assertTrue(instance.string.uri == "StringField")
