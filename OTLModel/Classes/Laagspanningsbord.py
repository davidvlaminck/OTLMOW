...
class Laagspanningsbord(AIMNaamObject):
    ...
    def __init__(self):
        ...
        self.elektrischSchema.uri = "https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Laagspanningsbord.elektrischSchema"
        ...
        self.vermogen.uri = "https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Laagspanningsbord.vermogen"
