...
class Ventilatie(AIMObject):
    ...
    def __init__(self):
        ...
        self.binnendiameter.uri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#Ventilatie.binnendiameter"
        ...
        self.buitendiameter.uri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#Ventilatie.buitendiameter"
        ...
        self.maximaalVolumedebiet.uri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#Ventilatie.maximaalVolumedebiet"
        ...
        self.vermogen.uri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#Ventilatie.vermogen"
