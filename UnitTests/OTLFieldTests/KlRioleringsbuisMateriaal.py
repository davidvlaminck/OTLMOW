...
class KlRioleringsbuisMateriaal(KeuzelijstField):
    ...
    options = {
        "PP-buizen": KeuzelijstWaarde("PP-buizen", "PP-buizen", "PP-buizen",
                        "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlRioleringsbuisMateriaal/PP-buizen"),
        "PVC-U-composietleidingen": KeuzelijstWaarde("PVC-U-composietleidingen", "PVC-U-composietleidingen", "PVC-U-composietleidingen",
                        "https://wegenenverkeer.data.vlaanderen.be/id/concept/KlRioleringsbuisMateriaal/PVC-U-composietleidingen"),
        "PVC-buizen": KeuzelijstWaarde("PVC-buizen", "PVC-buizen", "PVC-buizen",
