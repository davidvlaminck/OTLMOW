...
from src.OTLMOW.OTLModel.Datatypes.KlDynBordRSSMerk import KlDynBordRSSMerk
from src.OTLMOW.OTLModel.Datatypes.KlDynBordRSSModelnaam import KlDynBordRSSModelnaam
