...
class Baanlichaam(AIMObject):
    ...
    def __init__(self):
        ...
        self.dwarsprofiel.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Baanlichaam.dwarsprofiel"
        ...
        self.horizontaleLigging.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Baanlichaam.horizontaleLigging"
        ...
        self.langsprofiel.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/installatie#Baanlichaam.langsprofiel"
