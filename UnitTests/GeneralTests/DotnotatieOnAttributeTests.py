...
class DotnotatieOnAttributeTests(TestCase):
    def test_create_dotnotatie_on_attribute_level(self):
        ...
        with self.subTest('kwant waarde attribute'):
            self.assertEqual('theoretischeLevensduur.waarde', vr.theoretischeLevensduur._waarde.dotnotatie)
        ...
        with self.subTest('union attribuut'):
            self.assertEqual('masthoogte.afwijkendeHoogte.waarde', lichtmast.masthoogte.afwijkendeHoogte._waarde.dotnotatie)
