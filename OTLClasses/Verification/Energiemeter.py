...
class Energiemeter(AIMObject):
    ...
    antalTelwerken = IntField(naam="aantalTelwerken", label="aantal telwerken",
    ...
    meternummer = StringField(naam="meternummer", label="meternummer",
    ...
    metertype = KlEnergiemeterMetertype()
