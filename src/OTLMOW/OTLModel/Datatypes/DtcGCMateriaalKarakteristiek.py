...
from src.OTLMOW.OTLModel.Datatypes.KlLEGCGeluidskarakteristiek import KlLEGCGeluidskarakteristiek
from src.OTLMOW.OTLModel.Datatypes.KlLEGCMateriaal import KlLEGCMateriaal
