...
class Behuizing(AIMNaamObject):
    ...
    def __init__(self):
        ...
        self.adres.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#Behuizing.adres"
        ...
        self.risicoanalyse.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#Behuizing.risicoanalyse"
        ...
        self.tabelUitwendigeInvloeden.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#Behuizing.tabelUitwendigeInvloeden"
