...
class MeteropnameEnergiemeterGecombineerd(MeteropnameEnergiemeter):
    ...
    def __init__(self):
        ...
        self.meterstandPiek.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/proefenmeting#MeteropnameEnergiemeterGecombineerd.meterstandPiek"
        ...
        self.meterstandReactiefVermogenDag.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/proefenmeting#MeteropnameEnergiemeterGecombineerd.meterstandReactiefVermogenDag"
        ...
        self.meterstandReactiefVermogenNacht.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/proefenmeting#MeteropnameEnergiemeterGecombineerd.meterstandReactiefVermogenNacht"
