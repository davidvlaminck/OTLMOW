...
class StalenConstructieElement(ABC):
    ...
    def __init__(self):
        ...
        self.staalspecificaties.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#StalenConstructieElement.staalspecificaties"
        ...
        self.totaalGewicht.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/abstracten#StalenConstructieElement.totaalGewicht"
