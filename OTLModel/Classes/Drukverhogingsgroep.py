...
class Drukverhogingsgroep(Brandvoorziening):
    ...
    def __init__(self):
        ...
        self.inkomendeDruk.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Drukverhogingsgroep.inkomendeDruk"
        ...
        self.uitgaandeDruk.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Drukverhogingsgroep.uitgaandeDruk"
        ...
        self.vermogen.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Drukverhogingsgroep.vermogen"
