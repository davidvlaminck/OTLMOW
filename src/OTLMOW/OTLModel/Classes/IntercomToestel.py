...
from src.OTLMOW.OTLModel.Datatypes.KlIntercomMerk import KlIntercomMerk
from src.OTLMOW.OTLModel.Datatypes.KlIntercomModelnaam import KlIntercomModelnaam
