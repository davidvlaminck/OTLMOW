...
from src.OTLMOW.OTLModel.Datatypes.KlGekleurdWVCode import KlGekleurdWVCode
from src.OTLMOW.OTLModel.Datatypes.KlGekleurdWVSoort import KlGekleurdWVSoort
