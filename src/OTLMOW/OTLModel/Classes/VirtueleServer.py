...
from src.OTLMOW.OTLModel.Datatypes.KlVirtueleServerMerk import KlVirtueleServerMerk
from src.OTLMOW.OTLModel.Datatypes.KlVirtueleServerModelnaam import KlVirtueleServerModelnaam
