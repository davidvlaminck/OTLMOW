...
from src.OTLMOW.OTLModel.Datatypes.KlSlagboomkolomMerk import KlSlagboomkolomMerk
from src.OTLMOW.OTLModel.Datatypes.KlSlagboomkolomModelnaam import KlSlagboomkolomModelnaam
