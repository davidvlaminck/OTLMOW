...
from src.OTLMOW.OTLModel.Datatypes.KlSlagboomarmMerk import KlSlagboomarmMerk
from src.OTLMOW.OTLModel.Datatypes.KlSlagboomarmModelnaam import KlSlagboomarmModelnaam
