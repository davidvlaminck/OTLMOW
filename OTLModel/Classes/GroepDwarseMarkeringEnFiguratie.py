...
class GroepDwarseMarkeringEnFiguratie(AIMObject):
    ...
    def __init__(self):
        ...
        self.totaleOppervlakte.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/installatie#GroepDwarseMarkeringEnFiguratie.totaleOppervlakte"
        ...
        self.tussenruimte.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/installatie#GroepDwarseMarkeringEnFiguratie.tussenruimte"
