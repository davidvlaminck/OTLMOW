...
class MIVInstallatie(NaampadObject):
    ...
    def __init__(self):
        ...
        self.lusConfig.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/installatie#MIVInstallatie.lusConfig"
        ...
        self.technischeDocumentatie.objectUri = "https://wegenenverkeer.data.vlaanderen.be/ns/installatie#MIVInstallatie.technischeDocumentatie"
